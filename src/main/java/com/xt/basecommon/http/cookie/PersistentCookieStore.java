package com.xt.basecommon.http.cookie;
...
public class PersistentCookieStore {
    ...
    private static final String COOKIE_PREFS = "Xt_Cookies_Prefs";
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            Log.d("xt", "IOException in decodeCookie" + e.getMessage());
        } catch (ClassNotFoundException e) {
            Log.d("xt", "ClassNotFoundException in decodeCookie" + e.getMessage());
        }
