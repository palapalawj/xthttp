...
import com.xt.basecommon.http.body.ProgressResponseCallback;
import com.xt.basecommon.http.body.RequestBodyUtil;
import com.xt.basecommon.http.body.UploadProgressRequestBody;
...
public abstract class BaseRequestBody<R extends BaseRequestBody> extends BaseRequest<R> {
    ...
    public BaseRequestBody(String url) {
        super(url);
    }
    ...
    public <T> R params(String key, T file, String fileName, MediaType contentType,
                        ProgressResponseCallback responseCallBack) {
    ...
    protected Observable<ResponseBody> generateRequest() {
        if (this.requestBody != null) { //自定义的请求体
            ...
            RequestBody body = RequestBody.create(okhttp3
                    .MediaType.parse("application/json; charset=utf-8"), this.json);
            ...
            RequestBody body = RequestBody.create(okhttp3
                    .MediaType.parse("application/octet-stream"), this.bs);
            return apiManager.postBody(url, body);
        }
        ...
        for (Map.Entry<String, List<HttpParams.FileWrapper>> entry : params.fileParamsMap.entrySet()) {
            ...
            for (HttpParams.FileWrapper fileWrapper : fileValues) {
                ...
                UploadProgressRequestBody uploadProgressRequestBody =
                        new UploadProgressRequestBody(requestBody, fileWrapper.responseCallBack);
    ...
    private MultipartBody.Part addFile(String key, HttpParams.FileWrapper fileWrapper) {
        ...
        if (fileWrapper.responseCallBack != null) {
            ...
            MultipartBody.Part part = MultipartBody.Part
                    .createFormData(key, fileWrapper.fileName, uploadProgressRequestBody);
            return part;
        } else {
            MultipartBody.Part part = MultipartBody.Part
    ...
    private RequestBody getRequestBody(HttpParams.FileWrapper fileWrapper) {
        ...
        if (fileWrapper.file instanceof File) {
            ...
            requestBody = RequestBodyUtil.create(fileWrapper.contentType,
